export default {
  ...
  version: {
    ...
    products: {
      ...
      descriptionPlaceholder: '输入商品描述（选填）',
      type: '类型',
      typeBalance: '余额充值',
      ...
      value: '价值',
      valuePlaceholder: '输入价值（余额或天数）',
      valueHintBalance: '充值到账的余额金额',
      valueHintSubscription: '订阅有效期（天）',
      group: '关联分组',
      selectGroup: '选择分组',
      noGroup: '无',
      isActive: '启用',
    ...
    orders: {
      ...
      fulfillConfirm: '确定要手动完成此订单吗？请填写易支付交易号。',
      rejectReason: '拒绝原因',
      rejectReasonPlaceholder: '请输入拒绝原因',
      tradeNoPlaceholder: '请输入易支付交易号',
