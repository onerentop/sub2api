export default {
  ...
  auth: {
    ...
    invitationCodeInvalid: '无效的邀请码',
    invitationCodeRequired: '请输入邀请码',
    invitationCodeValidating: '邀请码正在验证中，请稍候',
  ...
  admin: {
    ...
    users: {
      ...
      allTypes: '全部类型',
      typeBalance: '余额（兑换）',
      typeAdminBalance: '余额（管理员）',
      typeConcurrency: '并发（兑换）',
      typeAdminConcurrency: '并发（管理员）',
      typeSubscription: '订阅',
      createdAt: '创建时间',
      // Settings Dropdowns
      filterSettings: '筛选设置',
      ...
      bulkActions: {
        ...
        edit: '批量编辑',
        deleteTitle: '批量删除用户',
        deleteMessage: '确定要删除选中的 {count} 个用户吗？此操作无法撤销。',
        deleteSuccess: '成功删除 {count} 个用户',
        deleteFailed: '删除失败 {count} 个用户',
        deleteError: '批量删除失败',
        enableSuccess: '成功启用 {count} 个用户',
        disableSuccess: '成功禁用 {count} 个用户',
        updateFailed: '更新失败 {count} 个用户',
        updateError: '批量更新失败',
        editTitle: '批量编辑 {count} 个用户',
        editDescription: '勾选要修改的字段，只有勾选的字段会被更新。',
        quotaDescription: '勾选后为所有选中用户设置限额，覆盖分组默认值。',
        balanceAdjustment: '余额调整',
        balanceAdjustmentHint: '正数增加余额，负数减少余额',
        balanceAdjustmentPlaceholder: '例如: 10 或 -5',
        noFieldsSelected: '请至少选择一个要修改的字段',
        updateSuccess: '成功更新 {count} 个用户',
        applyChanges: '应用更改'
      },
      attributes: {
        title: '用户属性配置',
    ...
    accounts: {
      ...
      exportFailed: '导出失败',
      noOAuthAccounts: '没有可导出的 OAuth 账号',
      dropFileHere: '拖拽文件到此处或点击上传',
      selectFile: '选择文件',
      supportedFormats: '支持 JSON 文件、多个 JSON 文件或 ZIP 压缩包',
      invalidFileFormat: '文件格式无效，需要 JSON 格式',
      noValidAccounts: '文件中没有找到有效的账号数据',
      processingFiles: '正在处理文件...',
      accountsToImport: '将导入 {count} 个账号',
      skipExisting: '跳过已存在的账号（按邮箱+平台匹配）',
      importing: '导入中...',
      importSuccess: '导入完成：新建 {created}，更新 {updated}，跳过 {skipped}',
      importFailed: '导入失败',
      hasToken: '有令牌',
      noToken: '无令牌',
      andMoreAccounts: '...还有 {count} 个账号',
      created: '新建',
      updated: '更新',
      skipped: '跳过',
      failed: '失败',
      ...
      status: {
        ...
        modelRateLimitedUntil: '{model} 模型限流中，重置时间：{time}',
    ...
    settings: {
      ...
      registration: {
        ...
        invitationCode: '邀请码',
        invitationCodeHint: '新用户注册时需要填写邀请码',
      ...
      payment: {
        title: '支付配置',
        description: '配置易支付集成，启用在线充值功能',
        enablePayment: '启用支付',
        enablePaymentHint: '允许用户通过支付宝/微信充值余额',
        apiUrl: '易支付 API 地址',
        apiUrlHint: '易支付平台的 API 地址',
        pid: '商户 PID',
        pidHint: '易支付商户号',
        key: '商户密钥',
        keyPlaceholder: '请输入商户密钥',
        keyConfiguredPlaceholder: '********',
        keyHint: '用于签名验证的商户密钥（请保密）',
        keyConfiguredHint: '密钥已配置，留空以保留当前值。',
        notifyUrl: '异步通知地址',
        notifyUrlHint: '支付成功后，易支付会向此地址发送异步通知',
        returnUrl: '同步跳转地址',
        returnUrlHint: '支付完成后，用户将跳转到此地址',
        quickSetCopy: '使用当前站点生成并复制',
        urlSetAndCopied: '已使用当前站点生成地址并复制到剪贴板',
        amountSettings: '金额设置',
        minAmount: '最小充值金额',
        minAmountHint: '单次充值的最小金额（元）',
        maxAmount: '最大充值金额',
        maxAmountHint: '单次充值的最大金额（元）',
        auditThreshold: '审核阈值',
        auditThresholdHint: '大于等于此金额的订单需要人工审核',
        cnyToValueRate: '金额转换比例',
        cnyToValueRateHint: '1 元 = ? 余额值，通常设为 1'
      },
      purchase: {
        title: '购买订阅页面',
        description: '配置外部购买订阅页面，嵌入到用户界面中',
        enabled: '启用购买订阅页面',
        enabledHint: '在用户界面显示购买订阅入口',
        url: '购买页面地址',
        urlPlaceholder: 'https://your-shop.com/subscription',
        urlHint: '外部购买订阅页面的完整 URL',
        iframeWarning: '⚠️ 部分网站设置了安全策略，禁止被嵌入到 iframe 中。如果页面显示空白或报错，请确认目标网站允许被嵌入。'
      },
      saveSettings: '保存设置',
      saving: '保存中...',
    ...
    orders: {
      ...
      approveOrder: '通过订单',
      rejectOrder: '拒绝订单',
      manualFulfillOrder: '手动完成订单',
      approveConfirm: '确定要通过此订单吗？用户余额将立即更新。',
      rejectConfirm: '确定要拒绝此订单吗？请填写拒绝原因。',
      fulfillConfirm: '确定要手动完成此订单吗？请填写交易号。',
      rejectReason: '拒绝原因',
      rejectReasonPlaceholder: '请输入拒绝原因',
      tradeNoPlaceholder: '请输入交易号',
  ...
  recharge: {
    ...
    getValue: '获得',
    subscriptionDesc: '{days} 天订阅',
    customAmount: '自定义金额',
    customAmountPlaceholder: '输入金额（{min}-{max}元）',
    customAmountHint: '汇率 1 CNY = {rate} USD',
    paymentMethod: '支付方式',
    minAmount: '最低 {min} 元',
    maxAmount: '最高 {max} 元',
    ...
    paying: '正在创建订单...',
    creating: '创建中...',
    auditWarning: '订单金额 ≥ ¥{threshold} 需要人工审核',
    recentOrders: '最近订单',
    noOrders: '暂无订单记录',
    orderNo: '订单号',
    amount: '金额',
    createdAt: '创建时间',
    // 订单状态（嵌套格式，用于动态key如 status.paid）
    status: {
      pending: '待支付',
      paid: '已支付',
      failed: '支付失败',
    ...
    statusAuditing: '审核中',
    statusRejected: '已拒绝',
    paymentDisabled: '支付功能未启用',
    paymentDisabledHint: '管理员尚未配置支付功能，请联系管理员开启',
    noProducts: '暂无可用商品',
    amountTooLow: '金额不能低于 {min} 元',
    amountTooHigh: '金额不能高于 {max} 元',
    orderCreated: '订单创建成功',
    orderFailed: '订单创建失败',
    ...
    orderAuditing: '订单金额较大，需要人工审核，请耐心等待',
    checkStatus: '查询状态',
    cancelPayment: '取消支付',
    yuan: '元',
    // 充值说明
    aboutRecharge: '充值说明',
    rule1: '充值后余额实时到账，可用于 API 调用消费',
    rule2: '订阅套餐购买后立即生效，有效期内享受对应权益',
    rule3: '单笔金额 ≥ ¥1000 需要人工审核，预计 1-2 个工作日',
    rule4: '如有问题请联系客服或管理员'
  }
}
