export default {
  ...
  auth: {
    ...
    invitationCodeValidating: 'Invitation code is being validated, please wait',
  ...
  admin: {
    ...
    dashboard: {
      ...
      last7Days: 'Last 7 Days',
      noUsageRecords: 'No usage records',
      startUsingApi: 'Start using the API and your usage history will appear here.',
    ...
    users: {
      ...
      bulkActions: {
        ...
        disable: 'Disable',
        edit: 'Edit',
        deleteTitle: 'Bulk Delete Users',
        deleteMessage: 'Are you sure you want to delete {count} selected users? This action cannot be undone.',
        deleteSuccess: 'Successfully deleted {count} users',
        deleteFailed: 'Failed to delete {count} users',
        deleteError: 'Bulk delete failed',
        enableSuccess: 'Successfully enabled {count} users',
        disableSuccess: 'Successfully disabled {count} users',
        updateFailed: 'Failed to update {count} users',
        updateError: 'Bulk update failed',
        editTitle: 'Bulk Edit {count} Users',
        editDescription: 'Check the fields you want to modify. Only checked fields will be updated.',
        quotaDescription: 'When checked, sets quota for all selected users, overriding group defaults.',
        balanceAdjustment: 'Balance Adjustment',
        balanceAdjustmentHint: 'Positive to add, negative to subtract',
        balanceAdjustmentPlaceholder: 'e.g., 10 or -5',
        noFieldsSelected: 'Please select at least one field to modify',
        updateSuccess: 'Successfully updated {count} users',
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierHint: 'Cost multiplier for this group',
        status: 'Status',
        statusLabel: 'Status',
        exclusive: 'Exclusive Group',
        exclusiveLabel: 'Exclusive',
        exclusiveHint: 'Exclusive groups require manual user assignment',
        accountsLabel: 'Accounts',
        accountsPlaceholder: 'Select accounts',
        priorityLabel: 'Priority',
        priorityHint: 'Higher priority groups are selected first'
      },
    ...
    accounts: {
      ...
      noOAuthAccounts: 'No OAuth accounts to export',
      dropFileHere: 'Drop files here or click to upload',
      selectFile: 'Select Files',
      supportedFormats: 'Supports JSON files, multiple JSON files, or ZIP archives',
      invalidFileFormat: 'Invalid file format, expected JSON',
      noValidAccounts: 'No valid accounts found in the files',
      processingFiles: 'Processing files...',
      accountsToImport: '{count} accounts to import',
      skipExisting: 'Skip existing accounts (match by email + platform)',
      importing: 'Importing...',
      importSuccess: 'Import complete: created {created}, updated {updated}, skipped {skipped}',
      importFailed: 'Import failed',
      hasToken: 'Has Token',
      noToken: 'No Token',
      andMoreAccounts: '...and {count} more accounts',
      created: 'Created',
      updated: 'Updated',
      skipped: 'Skipped',
      failed: 'Failed',
      ...
      status: {
        ...
        modelRateLimitedUntil: '{model} model rate limited until {time}',
      ...
      deleteConfirmMessage: "Are you sure you want to delete account '{name}'? This action cannot be undone.",
      ...
      form: {
        ...
        priorityLabel: 'Priority',
        priorityHint: 'Higher priority accounts are selected first',
        weightLabel: 'Weight',
        weightHint: 'Weight for load balancing',
        statusLabel: 'Status'
      },
      // Filters
      filters: {
      ...
      noAccountsDescription: 'Create your first account to get started.',
    ...
    proxies: {
      ...
      deleteConfirmMessage: "Are you sure you want to delete proxy '{name}'? Accounts using this proxy will have their proxy removed.",
      ...
      noProxiesDescription: 'Create your first proxy to get started.',
    ...
    redeem: {
      ...
      form: {
        ...
        balanceHint: 'Amount in USD to add to balance',
        concurrencyHint: 'Number of concurrent requests to add',
        countLabel: 'Count',
      ...
      deleteConfirmMessage: 'Are you sure you want to delete this redeem code? This action cannot be undone.',
      noCodes: 'No redeem codes',
      noCodesDescription: 'Generate your first redeem code to get started.',
      codesGeneratedSuccess: 'Codes generated successfully',
      codeDisabledSuccess: 'Code disabled successfully',
      codeEnabledSuccess: 'Code enabled successfully',
      codeDeletedSuccess: 'Code deleted successfully',
      failedToUpdate: 'Failed to update code'
    },
    ...
    settings: {
      ...
      registration: {
        ...
        invitationCodeHint: 'Require invitation code for new user registration',
      ...
      payment: {
        ...
        description: 'Configure YiPay integration to enable online payments',
        enablePayment: 'Enable Payment',
        enablePaymentHint: 'Allow users to top up balance via Alipay/WeChat',
        apiUrl: 'YiPay API URL',
        apiUrlHint: 'YiPay platform API URL',
        pid: 'Merchant PID',
        pidHint: 'YiPay merchant ID',
        key: 'Merchant Key',
        keyPlaceholder: 'Enter merchant key',
        keyConfiguredPlaceholder: '********',
        keyHint: 'Secret key for signature verification (keep it secret)',
        keyConfiguredHint: 'Key configured. Leave empty to keep the current value.',
        notifyUrl: 'Notify URL',
        notifyUrlHint: 'YiPay will send async notifications to this URL after payment',
        returnUrl: 'Return URL',
        returnUrlHint: 'Users will be redirected to this URL after payment',
        quickSetCopy: 'Generate & Copy (current site)',
        urlSetAndCopied: 'URL generated and copied to clipboard',
        amountSettings: 'Amount Settings',
        minAmount: 'Minimum Amount',
        minAmountHint: 'Minimum amount per payment (CNY)',
        maxAmount: 'Maximum Amount',
        maxAmountHint: 'Maximum amount per payment (CNY)',
        auditThreshold: 'Audit Threshold',
        auditThresholdHint: 'Orders at or above this amount require manual review',
        cnyToValueRate: 'CNY to Value Rate',
        cnyToValueRateHint: '1 CNY = ? balance value, usually set to 1'
      },
      purchase: {
        title: 'Purchase Subscription Page',
        description: 'Configure external purchase subscription page, embedded in user interface',
        enabled: 'Enable Purchase Subscription Page',
        enabledHint: 'Show purchase subscription entry in user interface',
        url: 'Purchase Page URL',
        urlPlaceholder: 'https://your-shop.com/subscription',
        urlHint: 'Full URL of the external purchase subscription page',
        iframeWarning: '⚠️ Some websites have security policies that prevent being embedded in iframes. If the page shows blank or errors, please confirm the target website allows embedding.'
      },
    ...
    orders: {
      ...
      batchDelete: 'Batch Delete',
      batchDeleteTitle: 'Batch Delete Orders',
      batchDeleteConfirm: 'Are you sure you want to delete {count} selected order(s)? This action cannot be undone.',
      batchDeleteSuccess: 'Successfully deleted {count} order(s)',
  ...
  recharge: {
    title: 'Recharge',
    description: 'Recharge your account balance or purchase subscription plans',
    currentBalance: 'Current Balance',
    concurrency: 'Concurrency',
    requests: 'requests',
    selectProduct: 'Select Product',
    balanceProducts: 'Balance Recharge',
    subscriptionProducts: 'Subscription Plans',
    balanceRecharge: 'Balance Recharge',
    subscriptionPurchase: 'Subscription Purchase',
    getValue: 'Get',
    subscriptionDesc: '{days} days subscription',
    customAmount: 'Custom Amount',
    customAmountPlaceholder: 'Enter amount ({min}-{max} CNY)',
    customAmountHint: 'Exchange rate: 1 CNY = {rate} USD',
    paymentMethod: 'Payment Method',
    minAmount: 'Minimum {min} CNY',
    maxAmount: 'Maximum {max} CNY',
    ...
    creating: 'Creating...',
    auditWarning: 'Orders ≥ ¥{threshold} require manual review',
    recentOrders: 'Recent Orders',
    noOrders: 'No orders yet',
    orderNo: 'Order No.',
    amount: 'Amount',
    createdAt: 'Created At',
    // Order status (nested format for dynamic keys like status.paid)
    status: {
      pending: 'Pending',
      paid: 'Paid',
      failed: 'Failed',
    ...
    // Order status (flat format for compatibility)
    ...
    paymentDisabled: 'Payment is not enabled',
    paymentDisabledHint: 'Payment has not been configured by the administrator. Please contact admin to enable it.',
    noProducts: 'No products available',
    amountTooLow: 'Amount cannot be less than {min} CNY',
    amountTooHigh: 'Amount cannot exceed {max} CNY',
    ...
    orderAuditing: 'Large order requires manual review, please wait',
    checkStatus: 'Check Status',
    cancelPayment: 'Cancel',
    yuan: 'CNY',
    // Recharge instructions
    aboutRecharge: 'About Recharge',
    rule1: 'Balance is credited instantly after payment and can be used for API calls',
    rule2: 'Subscription plans take effect immediately upon purchase',
    rule3: 'Orders ≥ ¥1000 require manual review, estimated 1-2 business days',
    rule4: 'For any questions, please contact support or administrator'
  }
}
