...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.UserOAuthBinding, c.UserSubscription,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		Product, PromoCode, PromoCodeUsage, Proxy, RedeemCode, Setting,
		UsageCleanupTask, UsageLog, User, UserAllowedGroup, UserAttributeDefinition,
		UserAttributeValue, UserOAuthBinding, UserSubscription []ent.Hook
	}
	inters struct {
		APIKey, Account, AccountGroup, Announcement, Group, OAuthProvider, PaymentOrder,
		Product, PromoCode, PromoCodeUsage, Proxy, RedeemCode, Setting,
		UsageCleanupTask, UsageLog, User, UserAllowedGroup, UserAttributeDefinition,
		UserAttributeValue, UserOAuthBinding, UserSubscription []ent.Interceptor
	}
)
