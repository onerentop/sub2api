...
func (_q *ProductQuery) QueryOrders() *PaymentOrderQuery {
...
func (_q *ProductQuery) QueryGroup() *GroupQuery {
...
func (_q *ProductQuery) WithOrders(opts ...func(*PaymentOrderQuery)) *ProductQuery {
	query := (&PaymentOrderClient{config: _q.config}).Query()
...
func (_q *ProductQuery) WithGroup(opts ...func(*GroupQuery)) *ProductQuery {
	query := (&GroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	...
	if query := _q.withOrders; query != nil {
		if err := _q.loadOrders(ctx, query, nodes,
			func(n *Product) { n.Edges.Orders = []*PaymentOrder{} },
			func(n *Product, e *PaymentOrder) { n.Edges.Orders = append(n.Edges.Orders, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *Product, e *Group) { n.Edges.Group = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ProductQuery) loadOrders(ctx context.Context, query *PaymentOrderQuery, nodes []*Product, init func(*Product), assign func(*Product, *PaymentOrder)) error {
...
func (_q *ProductQuery) loadGroup(ctx context.Context, query *GroupQuery, nodes []*Product, init func(*Product), assign func(*Product, *Group)) error {
...
func (_q *ProductQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withGroup != nil {
			_spec.Node.AddColumnOnce(product.FieldGroupID)
		}
	}
