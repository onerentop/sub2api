// Package antigravity provides signature caching for thinking blocks.
// This cache stores signatures received from upstream responses, allowing
// subsequent requests to use cached signatures instead of potentially
// invalid client-provided signatures.
package antigravity
