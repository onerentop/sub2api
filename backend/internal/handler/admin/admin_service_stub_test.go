...
func (s *stubAdminService) BulkUpdateUsers(ctx context.Context, input *service.BulkUpdateUsersInput) (*service.BulkUpdateUsersResult, error) {
	return &service.BulkUpdateUsersResult{
		Success:    len(input.UserIDs),
		Failed:     0,
		SuccessIDs: input.UserIDs,
		FailedIDs:  nil,
		Results:    nil,
	}, nil
}
...
func (s *stubAdminService) BatchDeleteUsers(ctx context.Context, ids []int64) (*service.BatchDeleteUsersResult, error) {
	return &service.BatchDeleteUsersResult{
		Success:    len(ids),
		Failed:     0,
		SuccessIDs: ids,
		FailedIDs:  nil,
