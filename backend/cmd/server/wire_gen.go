...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	account429Tracker := service.ProvideAccount429Tracker(configConfig)
	...
	antigravityGatewayService := service.ProvideAntigravityGatewayService(accountRepository, gatewayCache, antigravityTokenProvider, rateLimitService, httpUpstream, settingService, gatewayService)
