...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	entClientAndDB, err := repository.ProvideEntAndSQLDB(configConfig)
	if err != nil {
		return nil, err
	}
	client := repository.ProvideEntClient(entClientAndDB)
	db := repository.ProvideSQLDB(entClientAndDB)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, socialOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, productHandler, paymentOrderHandler, errorPassthroughHandler)
