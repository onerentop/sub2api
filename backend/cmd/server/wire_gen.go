...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	yiPayService := service.ProvideYiPayService(configConfig, settingService)
	paymentService := service.ProvidePaymentService(configConfig, paymentOrderRepository, productRepository, userRepository, subscriptionService, yiPayService, client, billingCacheService, settingService)
